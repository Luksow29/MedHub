...
export type NewDbInvoice = Omit<DbInvoice, 'id' | 'created_at' | 'updated_at' | 'user_id'>;
export type UpdateDbInvoice = Partial<Omit<DbInvoice, 'id' | 'created_at' | 'updated_at' | 'user_id'>>;

export type NewDbPayment = Omit<DbPayment, 'id' | 'created_at' | 'user_id'>;
export type UpdateDbPayment = Partial<Omit<DbPayment, 'id' | 'created_at' | 'user_id'>>;
