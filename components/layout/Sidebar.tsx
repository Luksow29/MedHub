...
interface SidebarProps {
  ...
  isOpen: boolean;
  isMobile: boolean;
  // 'currentPage' prop இங்கிருந்து நீக்கப்பட்டுள்ளது
  onToggle: () => void;
  onClose: () => void;
}
...
const Sidebar: React.FC<SidebarProps> = ({
  ...
  isOpen,
  isMobile,
  // 'currentPage' prop இங்கிருந்தும் நீக்கப்பட்டுள்ளது
  onClose
}) => {
      ...
      children: [
        {
          ...
          tamilLabel: 'சந்திப்புகள் பட்டியல்',
          icon: (
        ...
        },
        {
          ...
          tamilLabel: 'மேம்பட்ட அட்டவணையாளர்',
          icon: (
            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
