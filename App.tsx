...
// --- இந்த ஒரு வரியை மட்டும் புதிதாகச் சேர்க்கவும் ---
  ...
  return (
    <Router>
      <Routes>
        ...
        {/* Billing */}
        <Route path="/billing" element={<BillingPage user={session} onLogout={handleLogout} />} />
        <Route path="/billing/invoices/:invoiceId" element={<InvoiceDetails />} />

        {/* --- இந்த ஒரு Route-ஐ மட்டும் புதிதாகச் சேர்க்கவும் --- */}
        <Route path="/whatsapp-dashboard" element={<WhatsAppDashboardPage />} />
