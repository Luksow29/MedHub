...
import {
  Patient, NewDbPatient, DbPatient
} from '../../types';
...
const PatientDirectoryPage: React.FC<PatientDirectoryPageProps> = ({ user, onLogout }) => {
  ...
  return (
    <MainLayout
      ...
      breadcrumbs={[
        ...
        { label: getBilingualLabel('Patient Directory', 'நோயாளர் அடைவு') }
      ]}
      isLoading={isLoading}
    >
      {/* Error Display */}
